...
const FrequentlyAsked = () => {
    const FAQ = [
        ...
        },
        {
            ...
            answer: "Watch Netflix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from $11.99 to $79.99 a month. No extra costs, no contracts.",
        },
        {
            id: 2,
    ...
    return (
        <div className="bg-black text-white border-t-8 border-[#3A3A3A] pt-10">
